...
const EditProfile = ({ setOnEdit }) => {
    ...
    const [formData, setFormData] = useState({ name: auth.user.name, phone: auth.user.phone })
        ...
        <div className="edit_profile_form_container">
            ...
            <form>
                <div className='form-group form-field'>
                    <input className='form-control' name='name' type="text" value={formData.name} onChange={handleInputChange} placeholder="Name" />
                    <small className="form-text text-danger">{formError.name ? formError.name : ""}</small>
                </div>
                <div className='form-group form-field'>
